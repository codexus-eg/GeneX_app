...
import 'package:mokamal_online_platform/models/comment_model.dart';
import 'package:mokamal_online_platform/models/comment_std_data.dart';
import 'package:mokamal_online_platform/models/group_model.dart';
import 'package:mokamal_online_platform/models/invoice_model.dart';
import 'package:mokamal_online_platform/models/like_std_data.dart';
import 'package:mokamal_online_platform/models/otp_model.dart';
import 'package:mokamal_online_platform/models/payment_model.dart';
import 'package:mokamal_online_platform/models/posts_model.dart';
import 'package:mokamal_online_platform/models/purchased_exam_model.dart';
import 'package:mokamal_online_platform/models/purchases_widget_data.dart';
import 'package:mokamal_online_platform/models/user_purchased_chapter_model.dart';
import 'package:mokamal_online_platform/models/watches_video_model.dart';
import 'package:mokamal_online_platform/models/written_answs_model.dart';
...
import 'package:mokamal_online_platform/models/purchased_vid_model.dart';
import 'package:mokamal_online_platform/models/social_media_model.dart';
import 'package:mokamal_online_platform/models/std_quiz_model.dart';
import 'package:mokamal_online_platform/models/user_model.dart';
import 'package:mokamal_online_platform/models/user_purchase_model.dart';
...
import 'package:mokamal_online_platform/services/notification_service.dart';
...
*/
  ...
  Map<String, UserPurchasedModel> _mergeAndGetVideos(
    ...
    if (!um.purchasedVideos![chapId]!.lectures!.containsKey(lecId)) {
      um.purchasedVideos![chapId]!.lectures![lecId] =
          UserPurchasedLectureModel(videos: {}, status: 'paid', purchaseDateTime: DateTime.now(),);
    }
...
//////
  ...
  Future<void> sendNotification({
    ...
    final String url =
        'https://fcm.googleapis.com/v1/projects/mokamal-platform/messages:send';
